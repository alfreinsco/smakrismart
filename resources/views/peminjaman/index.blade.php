            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        ...
                        <a href="{{route('peminjaman.tambah')}}" class="btn btn-primary btn-sm mt-3 border"><i class="fa fa-minus-square"></i> Kembalikan Buku</a>
                    </div>
                </div>
                <div class="col-md-4">
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-header-right">
                                        <ul class="list-unstyled card-option">
                                            ...
                                            <li><a href="{{route('pengguna.tambah')}}"><i class="fa fa fa-user-plus"></i></a></li>
