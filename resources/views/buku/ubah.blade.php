        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="page-header-title">
                    <h5 class="m-b-10">Ubah Data Buku</h5>
                    <p class="m-b-0">Ubah data buku perpustakaan pada aplikasi <span class="text-warning">SMAKRISMART</span></p>
                </div>
            </div>
            <div class="col-md-4">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('buku.ubah', $buku->id)}}">Ubah</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>Ubah Data Buku Perpustakaan</h5>
                            ...
                            <div class="card-block">
                                <form class="form-material" action="{{route('buku.ubah', $buku->id)}}" method="POST" enctype="multipart/form-data">@csrf
                                    ...
                                    <div class="form-group form-default">
                                        <input name="pengarang" class="form-control @error('pengarang') is-invalid @enderror" value="{{old('pengarang') ?? ($buku->pengarang ?? '')}}" required>
                                        <span class="form-bar"></span>
                                    ...
                                    <div class="form-group form-default">
                                        <select name="kategori_id" class="form-control @error('kategori_id') is-invalid @enderror" required>
                                            ...
                                            @foreach($kategori as $v)
                                                <option @selected(old('kategori_id') == $v->id || (isset($buku) && $buku->kategori_id == $v->id))  value="{{ $v->id }}">{{ $v->nama }}</option>
                                            @endforeach
                                        </select>
                                        <span class="form-bar"></span>
